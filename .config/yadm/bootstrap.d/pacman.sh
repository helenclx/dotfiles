...
sudo pacman -S --needed bash bat easyeffects elisa eza fastfetch fcitx5 fcitx5-chinese-addons fcitx5-qt fcitx5-gtk fcitx5-configtool fish foliate fzf ghostwriter glow gpu-screen-recorder gpu-screen-recorder-ui halloy hyfetch kate kcharselect kitty konsole lazygit mpv mpv-mpris neovim ripgrep starship tealdeer tokodon vim zellij zoxide
