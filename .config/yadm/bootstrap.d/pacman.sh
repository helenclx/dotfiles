...
pacman_packages="bash bat easyeffects elisa fcitx5 fcitx5-chinese-addons fcitx5-qt fcitx5-gtk fcitx5-configtool fish foliate fzf ghostwriter kate kcharselect konsole mpv mpv-mpris neovim ripgrep starship tmux vim zoxide"
