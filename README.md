...
My yadm bootstrap program will install these software and dependencies after cloning my yadm repository. [paru](https://github.com/Morganamilo/paru) is my Arch User Repository (AUR) helper of choice, so my yadm bootstrap program will compile paru to install AUR packages.
